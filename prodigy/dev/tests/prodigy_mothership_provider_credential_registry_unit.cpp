...
int main(void)
{
...

  {
    ...
    if (!createAws)
    {
      basics_log("detail create_aws: %s\n", failure.c_str());
    }
    ...
    if (!upsertAws)
    {
      basics_log("detail upsert_aws: %s\n", failure.c_str());
    }
    ...
    if (!createAzure)
    {
      basics_log("detail create_azure: %s\n", failure.c_str());
    }
...

  {
    ...
    if (!reopenGetAws)
    {
      basics_log("detail reopen_get_aws: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetAzure)
    {
      basics_log("detail reopen_get_azure: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetAwsCli)
    {
      basics_log("detail reopen_get_aws_cli: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetAwsImds)
    {
      basics_log("detail reopen_get_aws_imds: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetGcpGcloud)
    {
      basics_log("detail reopen_get_gcp_gcloud: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetGcpImpersonation)
    {
      basics_log("detail reopen_get_gcp_impersonation: %s\n", failure.c_str());
    }
    ...
    if (!reopenGetGcpExternalAccount)
    {
      basics_log("detail reopen_get_gcp_external_account: %s\n", failure.c_str());
    }
    ...
    if (!removeAws)
    {
      basics_log("detail remove_aws: %s\n", failure.c_str());
    }
    ...
    if (!removeAzure)
    {
      basics_log("detail remove_azure: %s\n", failure.c_str());
    }
    ...
    if (!removeAwsCli)
    {
      basics_log("detail remove_aws_cli: %s\n", failure.c_str());
    }
    ...
    if (!removeAwsImds)
    {
      basics_log("detail remove_aws_imds: %s\n", failure.c_str());
    }
    ...
    if (!removeGcpGcloud)
    {
      basics_log("detail remove_gcp_gcloud: %s\n", failure.c_str());
    }
    ...
    if (!removeGcpImpersonation)
    {
      basics_log("detail remove_gcp_impersonation: %s\n", failure.c_str());
    }
    ...
    if (!removeGcpExternalAccount)
    {
      basics_log("detail remove_gcp_external_account: %s\n", failure.c_str());
    }
    ...
    if (!listEmpty)
    {
      basics_log("detail list_empty: %s\n", failure.c_str());
    }
