...
string(JSON CREDENTIAL_COUNT LENGTH "${PLAN}" apiCredentials requiredCredentialNames)
string(JSON CREDENTIAL_APP_ID GET "${PLAN}" apiCredentials applicationID)
string(JSON APPLICATION_ID GET "${PLAN}" config applicationID)
if (NOT CREDENTIAL_COUNT EQUAL 0 OR NOT CREDENTIAL_APP_ID EQUAL APPLICATION_ID)
   message(FATAL_ERROR "DNS resolver must explicitly declare no application API credentials")
endif()

foreach(FORBIDDEN IN ITEMS "tlsCredentials" "credentialUUID" "nThreads")
