...
int main(void)
{
  ...
  adopted.totalMemoryMB = 131'072;
  adopted.totalStorageMB = 1'024'000;
  ...
  adopted.ownedMemoryMB = 65'536;
  adopted.ownedStorageMB = 512'000;
  ...
  created.totalMemoryMB = 32'768;
  created.totalStorageMB = 204'800;
  created.ownership.mode = ClusterMachineOwnershipMode::wholeMachine;
  created.ownedLogicalCores = 6;
  created.ownedMemoryMB = 28'672;
  created.ownedStorageMB = 200'704;
...

  {
    ...
    authoritative.ownedStorageMB = 65'536;
    ...
    suite.expect(capturedLive.creationTimeMs == 123'456'789, "cluster_machine_backfill_restores_creation_time");
  }
  ...
  adoptedConfig.nMemoryMB = 131'072;
  adoptedConfig.nStorageMB = 1'024'000;
  ...
  suite.expect(adoptedResolved.totalMemoryMB == 131'072, "cluster_machine_percentages_total_memory");
  suite.expect(adoptedResolved.totalStorageMB == 1'024'000, "cluster_machine_percentages_total_storage");
  suite.expect(adoptedResolved.ownedLogicalCores == 16, "cluster_machine_percentages_resolve_cores");
  suite.expect(adoptedResolved.ownedMemoryMB == 98'304, "cluster_machine_percentages_resolve_memory");
  suite.expect(adoptedResolved.ownedStorageMB == 256'000, "cluster_machine_percentages_resolve_storage");
  ...
  suite.expect(wholeMachineResolved.totalMemoryMB == 32'768, "cluster_machine_whole_machine_total_memory");
  suite.expect(wholeMachineResolved.totalStorageMB == 204'800, "cluster_machine_whole_machine_total_storage");
  ...
  hardCapsResolved.ownership.nMemoryMBCap = 64'000;
  hardCapsResolved.ownership.nStorageMBCap = 250'000;
  ...
  suite.expect(hardCapsResolved.ownedMemoryMB == 28'672, "cluster_machine_hard_caps_resolve_memory");
  suite.expect(hardCapsResolved.ownedStorageMB == 200'704, "cluster_machine_hard_caps_resolve_storage");
  ...
  percentageClampResolved.ownership.nLogicalCoresBasisPoints = 10'000;
  percentageClampResolved.ownership.nMemoryBasisPoints = 10'000;
  percentageClampResolved.ownership.nStorageBasisPoints = 10'000;
  ...
  suite.expect(percentageClampResolved.ownedMemoryMB == 28'672, "cluster_machine_percentages_clamp_resolve_memory");
  suite.expect(percentageClampResolved.ownedStorageMB == 200'704, "cluster_machine_percentages_clamp_resolve_storage");
