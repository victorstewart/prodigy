...
public:
  ...
  {
    return tool.equals(other.tool) && phase.equals(other.phase) && command.equals(other.command) && output.equals(other.output) && failure.equals(other.failure) && exitCode == other.exitCode && attempted == other.attempted && succeeded == other.succeeded;
  }
...
public:
  ...
  bool operator==(const MachineCpuHardwareProfile& other) const
  {
    ...
    return vendor.equals(other.vendor) && model.equals(other.model) && architecture == other.architecture && architectureVersion.equals(other.architectureVersion) && logicalCores == other.logicalCores && physicalCores == other.physicalCores && sockets == other.sockets && numaNodes == other.numaNodes && threadsPerCore == other.threadsPerCore && l3CacheMB == other.l3CacheMB && singleThreadScore == other.singleThreadScore && multiThreadScore == other.multiThreadScore;
  }
...
public:
  ...
  {
    return locator.equals(other.locator) && manufacturer.equals(other.manufacturer) && partNumber.equals(other.partNumber) && serial.equals(other.serial) && sizeMB == other.sizeMB && speedMTps == other.speedMTps && technology == other.technology;
  }
...
public:
  ...
  bool operator==(const MachineMemoryHardwareProfile& other) const
  {
    ...
    return totalMB == other.totalMB && technology == other.technology && latencyNs == other.latencyNs && readBandwidthMBps == other.readBandwidthMBps && writeBandwidthMBps == other.writeBandwidthMBps;
  }
...
public:
  ...
  bool operator==(const MachineDiskBenchmarkProfile& other) const
  {
    ...
    return sequentialReadMBps == other.sequentialReadMBps && sequentialWriteMBps == other.sequentialWriteMBps && randomReadIops == other.randomReadIops && randomWriteIops == other.randomWriteIops && randomReadLatencyP50Us == other.randomReadLatencyP50Us && randomReadLatencyP95Us == other.randomReadLatencyP95Us && randomReadLatencyP99Us == other.randomReadLatencyP99Us && randomReadLatencyP999Us == other.randomReadLatencyP999Us && randomWriteLatencyP50Us == other.randomWriteLatencyP50Us && randomWriteLatencyP95Us == other.randomWriteLatencyP95Us && randomWriteLatencyP99Us == other.randomWriteLatencyP99Us && randomWriteLatencyP999Us == other.randomWriteLatencyP999Us && failure.equals(other.failure);
  }
...
public:
  ...
  bool operator==(const MachineDiskHardwareProfile& other) const
  {
    ...
    return name.equals(other.name) && path.equals(other.path) && model.equals(other.model) && serial.equals(other.serial) && wwn.equals(other.wwn) && kind == other.kind && bus == other.bus && formFactor == other.formFactor && pcieLink.equals(other.pcieLink) && pcieGeneration == other.pcieGeneration && pcieLanes == other.pcieLanes && logicalSectorBytes == other.logicalSectorBytes && physicalSectorBytes == other.physicalSectorBytes && sizeMB == other.sizeMB && mountPath.equals(other.mountPath) && benchmark == other.benchmark;
  }
...
public:
  ...
  {
    return address.equals(other.address) && subnet.equals(other.subnet) && gateway.equals(other.gateway) && internetReachable == other.internetReachable;
  }
...
public:
  ...
  bool operator==(const MachineNicHardwareProfile& other) const
  {
    ...
    return name.equals(other.name) && driver.equals(other.driver) && mac.equals(other.mac) && busAddress.equals(other.busAddress) && vendorID.equals(other.vendorID) && deviceID.equals(other.deviceID) && vendor.equals(other.vendor) && model.equals(other.model) && linkSpeedMbps == other.linkSpeedMbps && up == other.up;
  }
...
public:
  ...
  bool operator==(const MachineInternetBenchmarkProfile& other) const
  {
    ...
    return attempted == other.attempted && serverName.equals(other.serverName) && interfaceName.equals(other.interfaceName) && sourceAddress.equals(other.sourceAddress) && latencyMs == other.latencyMs && downloadMbps == other.downloadMbps && uploadMbps == other.uploadMbps && failure.equals(other.failure);
  }
...
public:
  ...
  bool operator==(const MachineGpuHardwareProfile& other) const
  {
    ...
    return vendor.equals(other.vendor) && model.equals(other.model) && busAddress.equals(other.busAddress) && memoryMB == other.memoryMB;
  }
...
public:
  ...
  {
    if (disks.size() != other.disks.size() || gpus.size() != other.gpus.size() || captures.size() != other.captures.size())
    {
      return false;
    }
    ...
    return cpu == other.cpu && memory == other.memory && network == other.network && collectedAtMs == other.collectedAtMs && inventoryComplete == other.inventoryComplete && benchmarksComplete == other.benchmarksComplete && inventoryFailure.equals(other.inventoryFailure) && benchmarkFailure.equals(other.benchmarkFailure);
  }
