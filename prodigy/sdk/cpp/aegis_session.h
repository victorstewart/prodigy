...
public:
  ...
  constexpr static std::size_t headerBytes = 24;
  constexpr static std::size_t maxFrameBytes = 2 * 1024 * 1024;
  constexpr static std::size_t minFrameBytes = 48;
  constexpr static std::size_t nonceBytes = 16;
  constexpr static std::int64_t pairingHashSeed = 0x4d595df4d0f33173LL;
  constexpr static std::size_t tagBytes = 16;
