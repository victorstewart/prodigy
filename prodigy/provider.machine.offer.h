...
{
  return providerMachineKindMaskBit(MachineConfig::MachineKind::bareMetal) | providerMachineKindMaskBit(MachineConfig::MachineKind::vm);
}
...
public:
  ...
  {
    return provider == other.provider && providerScope.equals(other.providerScope) && country.equals(other.country) && region.equals(other.region) && zone.equals(other.zone) && providerMachineType.equals(other.providerMachineType) && lifetime == other.lifetime && kind == other.kind && nLogicalCores == other.nLogicalCores && nMemoryMB == other.nMemoryMB && nStorageMB == other.nStorageMB && gpuCount == other.gpuCount && gpuMemoryMBPerDevice == other.gpuMemoryMBPerDevice && nicSpeedMbps == other.nicSpeedMbps && providesHostPublic4 == other.providesHostPublic4 && providesHostPublic6 == other.providesHostPublic6 && hasInternetAccess == other.hasInternetAccess && freeTierEligible == other.freeTierEligible && std::fabs(hourlyUSD - other.hourlyUSD) <= 1e-9;
  }
