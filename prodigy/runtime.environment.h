...
constexpr static uint32_t prodigyRuntimeTestInterContainerMTUDefault = 9000u;
constexpr static uint32_t prodigyRuntimeTestInterContainerMTUMin = 1280u;
constexpr static uint32_t prodigyRuntimeTestInterContainerMTUMax = 65'535u;
constexpr static uint32_t prodigyTCPHeaderBytes = 20u;
constexpr static uint32_t prodigyIPv4HeaderBytes = 20u;
constexpr static uint32_t prodigyIPv6HeaderBytes = 40u;
...
public:
  ...
  {
    return peerASN == other.peerASN && peerAddress.equals(other.peerAddress) && sourceAddress.equals(other.sourceAddress) && md5Password.equals(other.md5Password) && hopLimit == other.hopLimit;
  }
...
public:
  ...
  {
    return enabled || ourBGPID != 0 || community != 0 || nextHop4.isNull() == false || nextHop6.isNull() == false || peers.empty() == false;
  }

  bool operator==(const NeuronBGPConfig& other) const
  {
    if (enabled != other.enabled || ourBGPID != other.ourBGPID || community != other.community || nextHop4.equals(other.nextHop4) == false || nextHop6.equals(other.nextHop6) == false || peers.size() != other.peers.size())
    {
      return false;
    }
...
public:
  ...
  {
    return specified == other.specified && config == other.config;
  }
...
public:
  ...
  public:
    ...
    bool configured(void) const
    {
      return enabled || enableFakeIpv4Boundary || interContainerMTU != 0 || fakePublicSubnet4.network.isNull() == false || fakePublicSubnet6.network.isNull() == false;
    }

    bool operator==(const TestConfig& other) const
    {
      return enabled == other.enabled && enableFakeIpv4Boundary == other.enableFakeIpv4Boundary && interContainerMTU == other.interContainerMTU && fakePublicSubnet4.equals(other.fakePublicSubnet4) && fakePublicSubnet6.equals(other.fakePublicSubnet6);
    }
  ...
  public:
    ...
    bool configured(void) const
    {
      return bootstrapLaunchTemplateName.size() > 0 || bootstrapLaunchTemplateVersion.size() > 0 || bootstrapCredentialRefreshCommand.size() > 0 || bootstrapCredentialRefreshFailureHint.size() > 0 || instanceProfileName.size() > 0 || instanceProfileArn.size() > 0;
    }

    bool operator==(const AwsConfig& other) const
    {
      return bootstrapLaunchTemplateName.equals(other.bootstrapLaunchTemplateName) && bootstrapLaunchTemplateVersion.equals(other.bootstrapLaunchTemplateVersion) && bootstrapCredentialRefreshCommand.equals(other.bootstrapCredentialRefreshCommand) && bootstrapCredentialRefreshFailureHint.equals(other.bootstrapCredentialRefreshFailureHint) && instanceProfileName.equals(other.instanceProfileName) && instanceProfileArn.equals(other.instanceProfileArn);
    }
  ...
  public:
    ...
    bool configured(void) const
    {
      return bootstrapAccessTokenRefreshCommand.size() > 0 || bootstrapAccessTokenRefreshFailureHint.size() > 0;
    }

    bool operator==(const GcpConfig& other) const
    {
      return bootstrapAccessTokenRefreshCommand.equals(other.bootstrapAccessTokenRefreshCommand) && bootstrapAccessTokenRefreshFailureHint.equals(other.bootstrapAccessTokenRefreshFailureHint);
    }
  ...
  public:
    ...
    bool configured(void) const
    {
      return bootstrapAccessTokenRefreshCommand.size() > 0 || bootstrapAccessTokenRefreshFailureHint.size() > 0 || managedIdentityResourceID.size() > 0;
    }

    bool operator==(const AzureConfig& other) const
    {
      return bootstrapAccessTokenRefreshCommand.equals(other.bootstrapAccessTokenRefreshCommand) && bootstrapAccessTokenRefreshFailureHint.equals(other.bootstrapAccessTokenRefreshFailureHint) && managedIdentityResourceID.equals(other.managedIdentityResourceID);
    }
  ...
  bool configured(void) const
  {
    return kind != ProdigyEnvironmentKind::unknown || providerScope.size() > 0 || providerCredentialMaterial.size() > 0 || aws.configured() || gcp.configured() || azure.configured() || bgp.configured() || test.configured();
  }

  bool operator==(const ProdigyRuntimeEnvironmentConfig& other) const
  {
    return kind == other.kind && providerScope.equals(other.providerScope) && providerCredentialMaterial.equals(other.providerCredentialMaterial) && aws == other.aws && gcp == other.gcp && azure == other.azure && bgp == other.bgp && test == other.test;
  }
...
static inline bool prodigyRuntimeEnvironmentUsesManagedCloudNativeIdentity(const ProdigyRuntimeEnvironmentConfig& config)
{
  ...
  if (config.kind == ProdigyEnvironmentKind::aws)
  {
    return config.aws.instanceProfileName.size() > 0 || config.aws.instanceProfileArn.size() > 0;
  }
