...
inline void MachineSSH::restartProdigy(void)
{
  ...
  bool useBootstrapSshKeyPackage = bootstrapSshKeyPackage != nullptr && bootstrapSshKeyPackage->privateKeyOpenSSH.size() > 0 && bootstrapSshKeyPackage->publicKeyOpenSSH.size() > 0 && (sshPrivateKeyPath.size() == 0 || (bootstrapSshPrivateKeyPath != nullptr && sshPrivateKeyPath.equals(*bootstrapSshPrivateKeyPath)) || ::access(sshPrivateKeyPath.c_str(), R_OK) != 0);
