...
__attribute__((__always_inline__)) static inline void quicCidBuildIPv4DestinationKey(__u8 destination_key[QUIC_CID_DESTINATION_KEY_LEN], __be32 destination_address_network_order)
{
...
__attribute__((__always_inline__)) static inline void quicCidBuildIPv6DestinationKey(__u8 destination_key[QUIC_CID_DESTINATION_KEY_LEN], const __be32 destination_address_network_order[4])
{
...
__attribute__((__always_inline__)) static inline void quicCidDeriveTagForIPv4(__u8 tag[QUIC_CID_TAG_LEN], __u8 cidv, const __u8 container_id[5], __u32 nonce, __be32 destination_address_network_order, __u16 destination_port_network_order, __u8 proto)
{
...
__attribute__((__always_inline__)) static inline void quicCidDeriveTagForIPv6(__u8 tag[QUIC_CID_TAG_LEN], __u8 cidv, const __u8 container_id[5], __u32 nonce, const __be32 destination_address_network_order[4], __u16 destination_port_network_order, __u8 proto)
{
  __u8 destination_key[QUIC_CID_DESTINATION_KEY_LEN];
...
__attribute__((__always_inline__)) static inline bool quicCidTagMatches(const __u8 lhs[QUIC_CID_TAG_LEN], const __u8 rhs[QUIC_CID_TAG_LEN])
{
  return lhs[0] == rhs[0] &&
         lhs[1] == rhs[1] &&
         lhs[2] == rhs[2] &&
...
__attribute__((__always_inline__)) static inline __u8 quicCidEncryptedKeyIndex(const __u8 encrypted_cid[16])
{
  return (encrypted_cid[0] >> 7) & 0x01;
}

__attribute__((__always_inline__)) static inline __u32 quicCidPortalDecryptMapIndex(__u32 portal_slot, __u8 key_index)
{
